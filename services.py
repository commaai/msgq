...
_services: dict[str, tuple] = {
  ...
  "gpsNMEA": (True, 9.),
  "deviceState": (True, 1., 1),
  "can": (True, 100., 1223),  # decimation gives ~5 msgs in a full segment
  "controlsState": (True, 50., 10),
  "pandaStates": (True, 5., 1),
  "peripheralState": (True, 1., 1),
  "radarState": (True, 20., 5),
  "roadEncodeIdx": (False, 10., 1),
  "liveTracks": (True, 20.),
  ...
  "wideRoadEncodeIdx": (False, 10., 1),
  "wideRoadCameraState": (True, 20., 20),
  "modelV2": (True, 20., 40),
  "managerState": (True, 1., 1),
