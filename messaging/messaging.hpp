...
class SubMaster {
 public:
  SubMaster(std::vector<const char *> services, bool needPoller = true, const char *address = NULL, bool conflate = false, Context *context = NULL);
  ~SubMaster();
  ...
  SubMessage *receive(bool non_blocking = false);
 ...
 private:
  void createSocket(const char *endpoint, const char *address = NULL, bool conflate = false);
